  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-2 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header Principal del Dashboard - Responsivo */}
          ...
          <div className="px-4 sm:px-6 md:px-8 py-4 sm:py-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 sm:gap-4 mb-2">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white">Panel de Control Principal</h1>
                </div>
              </div>
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg sm:rounded-xl px-3 sm:px-4 py-1.5 sm:py-2 shadow-lg flex-shrink-0">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs sm:text-sm font-semibold text-white truncate">{roleName || 'Sin rol asignado'}</p>
                    </div>
                  </div>
                </div>
              </div>
