...
const AlertasMalla = ({ usuarioId }) => {
  ...
  return (
    <div className="w-full">
      <div className="w-full mb-4">
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-800">Alertas de Mallas</h3>
      ...
      <div className="w-full rounded-lg p-4 bg-gray-50 border border-gray-200">

        {error && (
          <div className="w-full mb-4 p-4 bg-red-100 border border-red-300 text-red-800 rounded-lg">
            {error}
          </div>
        )}
        ...
        <div className="w-full space-y-4">
          {alertas.map((alerta) => (
            <div
              key={alerta.idAlerta}
              className={`w-full border-2 rounded-lg p-4 ${obtenerColorPorTipo(alerta.tipoAccion)}`}
            >
